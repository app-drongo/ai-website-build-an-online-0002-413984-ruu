...
export default function Cta() {
  ...
  const handlePrimaryAction = () => {
    router.push('/'); // Shop Now - navigate to main store
  };
  const handleSecondaryAction = () => {
    router.push('/about'); // View Collection - learn about artisan process
  };
  // ACTION_PLACEHOLDER_END

  const stats = [
    { value: '2,500+', label: 'Handcrafted Pieces', icon: Sparkles },
    { value: '850+', label: 'Happy Customers', icon: Users },
    { value: '15+', label: 'Master Artisans', icon: Zap },
    { value: '100%', label: 'Authentic Gems', icon: Shield },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Each piece at Artisan Gems tells a story. Handcrafted by master artisans using
                ethically sourced gemstones, our jewelry celebrates your individual style and
                values.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Craftsmanship guarantee on all handmade pieces
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Personalized jewelry crafted to your vision
              </p>
            </div>
          </div>
        </div>
